		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> <small> <i
						class="icon-leaf"></i> 欢迎来到花园口腔医学美容医院网上信息一体化系统！
				</small>				</a>
				<!-- /.brand -->
			</div>
			<!-- /.navbar-header -->
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
			    ...
			    <li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text">主治医师一览</span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
                            <li><a href="<%=basePath%>welcome/findAllDoctor.do" target="mainframe"> <i
				 ...
				 <li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text">我的预约记录</span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
                            <li><a href="<%=basePath%>order/cusOrderList.do" target="mainframe"> <i
									class="icon-double-angle-right"></i> 查看
							</a></li>
				</li>
				</ul>
					 <li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text">我的消费记录</span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
                            <li><a href="<%=basePath%>chufang/cusChufangList.do" target="mainframe"> <i
									class="icon-double-angle-right"></i> 查看
							</a></li>
				</li>
					 ...
					 <li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text">我的评价记录</span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
                            <li><a href="<%=basePath%>evaluate/cusEvaluateList.do" target="mainframe"> <i
									class="icon-double-angle-right"></i> 查看
							</a></li>
				</li>
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="<%=basePath%>empMain/showPageCustomer.do"
