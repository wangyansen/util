...
<form action="<%=basePath%>chufang/chufangAddTwo.do" method="post" class="form-horizontal">
    ...
    <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text"  class="form-control input-sm" value="${userName}" readonly="readonly" name="doctorName" />
                </div>
            </div>
        </div>
    </div>
    <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text"  class="form-control input-sm" name="sickerName"/>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text"  class="form-control input-sm" name="sickName"/>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-sm-9">
                	<select name="medicalApplianceId" class="form-control input-sm">
                    	<c:forEach items="${medicalApplianceList}" var="medicalApplianceList">
                    		<option value="${medicalApplianceList.id }">${medicalApplianceList.medicalApplianceName }</option>
                		</c:forEach>
                    </select>
                </div>
            </div>
    ...
    <div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="date" name="openTime" class="form-control input-sm" placeholder="请输入沟通时间"/>
                </div>
            </div>
        </div>
    </div>
